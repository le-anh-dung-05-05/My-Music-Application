                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          AlbumCard(
                            label: "Best Mode",
                            image: AssetImage("assets/album7.jpg"), onTap: null,
                          ),
                          SizedBox(width: 16),
                          AlbumCard(
                            label: "Mot6ivation Mix",
                            image: AssetImage("assets/album2.jpg"), onTap: null,
                          ),
                          SizedBox(width: 16),
                          AlbumCard(
                            label: "Top 50-Global",
                            image: AssetImage("assets/top50.jpg"), onTap: null,
                          ),
                          SizedBox(width: 16),
                          AlbumCard(
                            label: "Power Gaming",
                            image: AssetImage("assets/album1.jpg"), onTap: null,
                          ),
                          SizedBox(width: 16),
                          AlbumCard(
